...
line = new Layer
	...
	width: example_prototypeCell.width - 10
	backgroundColor: "#DADADA"

example_scroll = new PrototypeScrollComponent
	frame: Screen.frame
	backgroundColor: null
	scrollHorizontal: false
	numberOfItems: data.length
	prototypeItem: example_prototypeCell

# Original prototype layer will destroyed from hierarchy
example_scroll.content.addChild example_prototypeCell

example_scroll.forItemAtIndex = ( index, layer ) ->
	cell = layer.copy()	
